...
#define WINDOW_TITLE "Animated Pyramid"
...
void URenderGraphics(void)
{
	...
	model = glm::rotate(model, glutGet(GLUT_ELAPSED_TIME) * -0.0005f, glm::vec3(0.0, 1.0f, 0.0f));     // Rotate the cube every second by 0.0005f degrees in XYZ
